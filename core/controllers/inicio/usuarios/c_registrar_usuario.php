...
use Plataforma\Libs\Validate;
	...
	$insertar = $obj_usuario->insertar($correo,$nombres,$tipo_id,$identificacion,$telefono,$municipio,$img_preview,$img_usuario,$usuario,$password,$tipo_usuario,$codigo,$fecha_codigo,$carpeta_usuario,$fecha);
    if ($insertar == True){
