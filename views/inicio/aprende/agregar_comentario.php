...
<main>
	<div class="main" id="agregar_comentario">
		<div class="contenido">
			...
			if ($flag_empty === False){ ?>
			<form id="form_agregar_comentario" class="form" method="POST" action="<?php echo CONTROLLERS?>inicio/aprende/c_agregar_comentario.php">
				...
				<div class="input s100">
					...
					<div class="contenido_input"><textarea class="input input_text" name="comentario"  placeholder="Escribir comentario..."></textarea></div>
				</div>
				...
				<div class="content_button next">
					<button type="submit" class="button"><i class="icon-filled-editar-b"></i>Aceptar</button>
				</div>
			</form>
		<?php } ?>
		</div>
